...
class SiteThemeUpdateComponent extends Component {
    ...
    render() {
        const wordpressThemes = this.props.wordpressThemes;
        const wpThemeUpdateLoading = this.props.wpThemeUpdateLoading;
        return (
            <React.Fragment>
                        ...
                        this.props.wordpressThemes.map((wpthemes, key) => {
                            return (
                                <Card>
                                    <Card.Header>
                                        <Row className="align-items-center">
                                            <Col md={3}>{wpthemes.name}</Col>
                                            <Col md={3}>
                                                {wpthemes.update_version}
                                            </Col>
                                            <Col md={3}>{wpthemes.updates}</Col>
